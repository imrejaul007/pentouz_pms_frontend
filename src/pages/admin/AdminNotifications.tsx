...
export default function AdminNotifications() {
  ...
  useEffect(() => {
    console.log('[AdminNotifications] Establishing WebSocket connection with singleton pattern');
    connect().catch(error => {
      console.error('[AdminNotifications] WebSocket connection failed:', error);
    });
    return () => {
      console.log('[AdminNotifications] Component unmounting, keeping singleton connection active');
