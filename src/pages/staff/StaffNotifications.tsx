...
export default function StaffNotifications() {
  ...
  useEffect(() => {
    connect().catch(error => {
      console.error('[StaffNotifications] WebSocket connection failed:', error);
    });
    return () => {
      console.log('[StaffNotifications] Component unmounting, keeping singleton connection active');
